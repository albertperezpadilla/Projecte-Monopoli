...
def totalPagar(posicio):
    ll_casas = dic.carrers[posicio]["Ll. Casa"] * dic.carrers[posicio]["Num. Cases"]
    ll_hotels = dic.carrers[posicio]["Ll. Hotel"] * dic.carrers[posicio]["Num. Hoteles"]
...
def opcions_jugador(color):
    ...
    if posicio != 12:
        if posicio not in [0, 3, 6, 9, 12, 15, 18, 21]:
            if dic.carrers[posicio]["Propietari"] == "banca":
                opcions.append("comprar terreny")
            elif dic.carrers[posicio]["Propietari"] == color:
                if dic.carrers[posicio]["Num. Cases"] < 4:
                    opcions.append("comprar casa")
                if dic.carrers[posicio]["Num. Hoteles"] < 2:
                ...
                if "no pot pagar":
                    "opcions"
print("hola")
print(totalPagar(dic.jugadors["groc"]['posicio']))